$(document).ready(function() {
  ...
  $('.ps').click(function(){ 
       if(onoff==true){
		   ...
		   $(this).css('background','url(images/play.png)no-repeat center').css('background-size','cover');;
           onoff=false;   
	   }else{  // false
		  timeonoff= setInterval( moveg , 5000); //play버튼 클릭시
		   $(this).css('background','url(images/stop.png)no-repeat center').css('background-size','cover');
		   onoff=true; 
	   }
  });	
